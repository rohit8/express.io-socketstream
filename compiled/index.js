...
(function() {
  var ss, path, RequestIO, RoomIO, async, connect, express, http, https, initRoutes, io, key, listen, middleware, session, sessionConfig, value, _;
    ...
    setRoute = function(key, callback) {
      ...
      */
      return socket.on(key, function(data, respond) {
        ...
        return callback(request, delivery);
      });
